...
public class AddressDto {
    ...
    public AddressDto(Long id, Long userId, Long restaurantId, String street, String state, String zipCode, String country, String addressLine, String city, BigDecimal latitude, BigDecimal longitude, Boolean isVerified, String placeId, String formattedAddress, String deliveryInstructions, String addressType, String floor, String apartment, Boolean isDefault) {
        this.id = id;
        this.userId = userId;
    ...
    public static class Builder {
        ...
        public AddressDto build(){ return new AddressDto(id,userId,restaurantId,street,state,zipCode,country,addressLine,city,latitude,longitude,isVerified,placeId,formattedAddress,deliveryInstructions,addressType,floor,apartment,isDefault); }
    }
