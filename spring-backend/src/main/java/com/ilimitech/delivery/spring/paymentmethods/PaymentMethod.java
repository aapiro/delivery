...
public class PaymentMethod {
    ...
    private Long userId; private String type; private String provider;
    private String token; private String lastFour;
    private Boolean isDefault; private Boolean isActive;
