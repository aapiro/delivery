...
public class CreateAddressDto {
    ...
    public CreateAddressDto(Long userId, Long restaurantId, String street, String state, String zipCode, String country, String addressLine, String city, BigDecimal latitude, BigDecimal longitude, Boolean isVerified, String placeId, String formattedAddress, String deliveryInstructions, String addressType, String floor, String apartment, Boolean isDefault) {
        this.userId = userId;
    ...
    public static class Builder {
        ...
        public CreateAddressDto build(){ return new CreateAddressDto(userId,restaurantId,street,state,zipCode,country,addressLine,city,latitude,longitude,isVerified,placeId,formattedAddress,deliveryInstructions,addressType,floor,apartment,isDefault); }
    }
